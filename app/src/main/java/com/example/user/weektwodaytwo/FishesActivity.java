...
public class FishesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Fishs List");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        /////   instantiating   data reader classs

        DataReader   dataReader = new DataReader(this,"fish");
        ...
        ListView lvFish =(ListView) findViewById(R.id.lvFish);
        lvFish.setAdapter(customAdapter);



        lvFish.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {


                Toast.makeText(FishesActivity.this, "clicked" + animalsList.get(position), Toast.LENGTH_LONG).show();
            }
        });
